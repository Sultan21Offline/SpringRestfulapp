...
public class UserController {
    ...
    public ResponseEntity<User>updateUser(@RequestParam(value = "id") String id,@RequestParam(value = "username") String username){
        return ResponseEntity.ok().body(userService.updateUser(id,username));
    }
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try{
                ...
                User user = userService.getUseruser(username);
